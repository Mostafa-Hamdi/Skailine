...
const page = () => {
  return (
    <div className='innovation-driven '>
        <Return pageName="Innovation-driven demand planning" collectionName="AI Case Studies" heading="Case Studies"/>
