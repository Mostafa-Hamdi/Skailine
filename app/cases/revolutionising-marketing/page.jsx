...
import Return from '../geospatial-sales/Return'
import { case1,case2,case3 } from '@/app/assets'
const page = () => {
  return (
    <div className=" py-12 md:py-20">
        <Return pageName="Revolutionising Marketing Strategies in a Commoditised Market" collectionName="AI Case Studies" heading="Case Studies"/>
        <div className="container py-12 md:py-20 flex flex-col aftmd:flex-row max-w-[540px]  md:max-w-[720px] aftmd:max-w-[960px] aftlg:max-w-[1140px]  aftxl:max-w-[1320px] mx-auto">
            ...
            <div className="latest order-[0] aftmd:order-10 px-3 aftmd:flex-1">    
                <AllCaseDescription
                    link="revolutionising-marketing" 
                    img={case1}
                    date="April 24, 2024"
